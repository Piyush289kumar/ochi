...
function About() {
    return (
        <>
            <div className=' bg-[#CDEA68] rounded-t-2xl'>
                ...
                <div className='bg-[#CDEA68] border-t-[1px] border-zinc-500 px-12 pt-4 mt-5 pb-12 flex'>
                    <div className='w-1/2'>
                        ...
                        <button className='bg-zinc-950 px-6 py-4 text-md rounded-full text-white uppercase flex items-center justify-between gap-8'>Read More
                            <div className='w-2 h-2 rounded-full bg-zinc-50'></div></button>
                    </div>
                    <div className='w-1/2 flex items-center'>
                        <img
