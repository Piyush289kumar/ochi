...
function PlaySection() {
    ...
    return (
        <div className="w-full h-screen overflow-hidden -z-[1] relative">
            <div data-scroll data-scroll-section data-scroll-speed="-.6" className='relative w-full h-screen cursor-pointer bg-cover bg-center bg-[url("https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg")]'>
